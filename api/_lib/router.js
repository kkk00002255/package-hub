...
export const MODEL_ROUTING = {
  ...
  'step-3.7-flash': {
    candidates: [
      { upstream: 'siliconflow', model: 'stepfun-ai/Step-3.5-Flash', costUSD: 0.2, priority: 1, note: '超快' },
      { upstream: 'zhipu', model: 'glm-4-flash', costUSD: 0.1, priority: 2, note: '智谱 GLM 4 Flash 备选' },
      { upstream: 'openrouter', model: 'liquid/lfm-2.5-1.2b-instruct:free', costUSD: 0, priority: 3, note: 'OR 免费 fallback' },
    ],
    status: 'live',
  },
  'mimo-v2.5-pro': {
    candidates: [
      ...
      { upstream: 'siliconflow', model: 'MiniMaxAI/MiniMax-M2.5', costUSD: 0.4, priority: 2, note: 'MiniMax 同级别' },
